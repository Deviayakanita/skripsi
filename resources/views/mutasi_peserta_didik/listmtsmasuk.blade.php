...
<ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="treeview">
      ...
      <ul class="treeview-menu">
        <li><a href="{{url('peserta_didik/listpesertadidik')}}"><i class="fa fa-circle-o"></i> Data Peserta Didik</a></li>
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            <li><a href="/listmutasimasuk"><i class="fa fa-circle-o"></i> Data Mutasi Masuk</a></li>
            <li><a href="/listmutasikeluar"><i class="fa fa-circle-o"></i> Data Mutasi Keluar</a></li>     
        </ul>
    </li>
    <li class="treeview">
  ...
  <div class="row">
    <div class="col-xs-12">
        <div class="box">
          ...
          <td>
            <a href="index"><button type="button" class="btn btn-block btn-primary">Tambah Mutasi Masuk</button></a>
          </td>
        </div>
